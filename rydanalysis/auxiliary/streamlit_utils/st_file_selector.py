...
def st_file_selector(st_placeholder, path=".", label="Please, select a file/folder..."):
    ...
    # list files in base _path directory
...
if __name__ == "__main__":
    ...
    if not st_session_state:
        st_session_state.input_path = "../../../streamlit_apps"

    st_session_state.input_path = st_file_selector(
        st_placeholder=st.empty(), path=st_session_state.input_path, label=f"Input path"
    )
