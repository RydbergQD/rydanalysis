...
class LightAnalysis:
    ...
    @classmethod
    def from_raw_data(cls, raw_data: xr.Dataset, light_mask=None, transition=DipoleTransition()):
        ...
        return cls(images, t_exp=t_exp, binning=binning,
    ...
    @property
    def power(self):
        return get_power(self.light_images, self.t_exp, self.QUANTUM_EFFICIENCY, self.transition)
...
def get_field_strength(images, t_exp, quantum_efficiency=LightAnalysis.QUANTUM_EFFICIENCY,
...
def get_rabi_frequency(images, t_exp, quantum_efficiency=LightAnalysis.QUANTUM_EFFICIENCY,
                       transition=DipoleTransition(), pixel_size=LightAnalysis.SINGLE_PIXEL_SIZE):
    field_strength = get_field_strength(images, t_exp, quantum_efficiency, transition, pixel_size)
